...
class workflow_HW(object):
    ...
    def __init__(self, param_file, action, mean_flow):
        ...
        if action is None:
            ...
            elif action == 'trackingMF':
                self.do_tracking_MF(mean_flow)
    ...
    def do_tracking(self):
        ...
        # do the tracking
        #t4f.track_all_frames_w_changing_flow(mean_flow=mean_flow,frames=frames)
    ...
    def do_tracking_MF(self, mean_flow):
        '''
        Will perform the tracking using the file given parameters.
        '''
        #import myptv.tracking_mod_HW as tmHW
    
        from Experiment.myptv.tracking_mod_HW import tracker_four_frames
        
        #from myptv.tracking_mod_HW import track_all_frames_w_changing_flow
        from numpy import array
        from os import getcwd, listdir
        from os.path import exists as pathExists
